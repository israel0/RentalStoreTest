...
<div class="grid columns-12 gap-6 mt-5">
    <div class="intro-y g-col-12 d-flex flex-wrap flex-sm-nowrap align-items-center mt-2">
       <a href="#">  <button class="btn btn-primary shadow-md me-2">Item Current State</button></a>
        <div class="dropdown">
        ...
        <table class="table table-report mt-n2">
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    ...
                    <td>
                        <a href="" class="fw-medium text-nowrap"> {{ $item->item_name }} </a> 
                        <div class="text-gray-600 fs-xs text-nowrap mt-0.5">{{ $item->rent_date }} </div>
                    </td>
                    <td>
                        <a href="" class="fw-medium text-nowrap"> <span>NGN</span> {{ $item->price }} </a> 
                        
                    </td>

                     <td class="table-report__action w-56">
                        <div class="d-flex justify-content-center align-items-center">
                            <a  href="#" class="d-flex align-items-center me-3"> <i data-feather="check-square" class="w-4 h-4 me-1"></i> {{ $item->status }} </a>                                  
                        </div>
                    </td>
